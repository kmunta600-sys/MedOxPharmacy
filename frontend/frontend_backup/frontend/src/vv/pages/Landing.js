...
const Landing = () => {
    ...
    const readAboutAloud = () => {
        ...
        const fullText = 
            ...
            "NexusRX is proud to provide MedOx Pharmacy with a state-of-the-art inventory management solution. " +
            ...
            "Built by NexusRX. Made in Malawi.";
        ...
        <div className="about-overlay" onClick={() => {
            ...
            <div className="about-modal" onClick={(e) => e.stopPropagation()}>
                ...
                <p className="about-description">
                    NexusRX is proud to provide MedOx Pharmacy with a state-of-the-art inventory 
                ...
                <div className="about-powered">
                    ...
                    <span className="about-powered-brand">NexusRX</span>
                </div>
            ...
            <div className="landing-footer">
                ...
                <div className="landing-footer-right">
                    ...
                    <span className="footer-powered">
                        ...
                        <span className="powered-brand">NexusRX</span>
                    </span>
                </div>
            </div>
        </div>
